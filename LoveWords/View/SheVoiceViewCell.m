...
#import "SheVoiceViewCell.h"
#import "UITableViewCell+Config.h"
#import "UIButton+WebCache.h"
#import <AVFoundation/AVFoundation.h>


@interface SheVoiceViewCell ()
...
@end
@implementation SheVoiceViewCell
-(void)configCell:(Message *)msg
{
    ...
    [self.buttonOfHeadImage sd_setBackgroundImageWithURL:[NSURL URLWithString:msg.headImageOfHer] forState:UIControlStateNormal];
...
-(void)tapImageViewOfMessage
{
    ...
    for (int i=0; i<4; i++)
    {
        ...
        NSString *imageName=[NSString stringWithFormat:@"chat_receiver_audio_playing00%d@2x.png",i];
